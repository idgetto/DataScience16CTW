...
2. in data/congress_db.py change the variable ROOT to the absolute path to your clones DataScience16CTW directory
3. run `jupyter notebook deliverable/deliverable.py`
